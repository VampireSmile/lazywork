...
/**
 * Servlet implementation class GetOwnData_Servlet
 */
public class GetOwnData_Servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String out_stream = deal.getOwninfo(request.getParameter("_allid"));
